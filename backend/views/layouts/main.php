        ...
        <nav class="navbar horizontal-menu navbar-fixed-top"><!-- set fixed position by adding class "navbar-fixed-top" -->
            ...
            <div class="navbar-inner">
                ...
                <ul class="navbar-nav">
                    ...
                    ?>
                    <li>
                        <?= Html::a('<i class="fa fa-sitemap"></i> <span class="title">About SIA</span>', ['/cms/about/update', 'id' => 1], ['class' => 'title']) ?>
                    </li>
                    <li>
                        <a href="">
                        ...
                        <ul>
                            ...
                            <li>
                                <?= Html::a('<i class="fa fa-angle-double-right"></i> Common Contents', ['/cms/common-contents/update', 'id' => 1], ['class' => 'title']) ?>
                            </li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        <?= Html::a('<i class="fa fa-map-marker"></i> <span class="title">Contact Address</span>', ['/cms/contact-info/update', 'id' => 1], ['class' => 'title']) ?>
                    </li>
                    <li>
                    ...
                    <li>
                        <?= Html::a('<i class="fa fa-caret-square-o-right"></i> <span class="title">Careers</span>', ['/cms/careers/index'], ['class' => 'title']) ?>
                    </li>
                </ul>
                ...
                <footer class="main-footer sticky footer-type-1">
                    ...
                    <div class="footer-inner">
                        ...
                        <div class="footer-text">
                            <strong>Copyright© 2018 SIA Accounting & Auditing LLC. All rights reserved.</strong>
                        </div>
