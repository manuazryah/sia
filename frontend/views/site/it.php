...
if (isset($it_service->meta_title) && $it_service->meta_title != '') {
    $this->title = $it_service->meta_title;
} else {
    $this->title = 'IT Service';
}
?>
<meta property="og:site_name" content="Avensia Group" />

<meta property="og:type" content="Summary" />

<meta property="og:title" content="<?= $this->title ?>" />

<meta property="og:image" content="<?= yii::$app->homeUrl ?>images/banner/in-banner.jpg" />

<meta property="og:description" content="<?= $it_service->meta_description ?>" />

<meta property="og:url" content="<?= $it_service->page_url ?>" />
