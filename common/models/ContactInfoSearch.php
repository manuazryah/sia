...
class ContactInfoSearch extends ContactInfo
{
    ...
    public function rules()
    {
        return [
            ...
            [['dubai_office_address', 'sharjah_office_address', 'phone', 'webpage', 'email', 'DOC'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'dubai_office_address', $this->dubai_office_address])
            ->andFilterWhere(['like', 'sharjah_office_address', $this->sharjah_office_address])
