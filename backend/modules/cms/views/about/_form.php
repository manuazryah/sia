...
<div class="about-form form-inline">
    ...
    <div class="row">
        <div class='col-md-6 col-sm-6 col-xs-12 left_padd'>
            <?= $form->field($model, 'image', ['options' => ['class' => 'form-group'], 'template' => '{label}<label>About Image [ File Size :( 551x551 ) ]</label>{input}{error}'])->fileInput(['maxlength' => true])->label(FALSE) ?>
            <?php
            if ($model->isNewRecord)
                ...
                if (!empty($model->image)) {
                    ...
                    <img class="img-responsive" src="<?= Yii::$app->homeUrl ?>../uploads/about/small.<?= $model->image; ?>?rand()"/>
                    <?php
                }
            }
            ?>
